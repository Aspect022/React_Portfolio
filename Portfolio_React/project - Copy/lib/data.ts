...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A backend-driven job portal built with Java Spring Boot and MySQL, enabling job listings, applications, user authentication, and admin management dashboard.",
  ...
  },
  {
    ...
    description: "A desktop-based solar system simulation developed using Javascript Threejs, visualizing the motion of planets around the sun in a static orrey layout.",
    imageUrl: "https://media.istockphoto.com/id/182792016/photo/solar-system.jpg?s=612x612&w=is&k=20&c=ZMtqgBg4ua_ZB3blT357A-sVZEkgyn4uvGHneFAh430=",
  ...
  },
  {
    ...
    description: "A machine learning-powered system predicting loan approval chances based on user-provided financial and demographic details, featuring data preprocessing and model tuning.",
  ...
  },
  {
    ...
    description: "A Python-based tool that summarizes lecture transcripts into structured notes using NLP techniques for easier revision and study preparation.",
...

  {
    ...
    description: "A 2D platformer adventure game created in Java using object-oriented programming and collision detection principles for engaging gameplay.",
...
export const experiences: ExperienceItem[] = [
  {
    ...
    startDate: "Jan 2025",
    endDate: "Feb 2025",
    description: "Worked as a Backend Developer Intern focusing on Java Spring Boot and SQL-based backend systems for data-driven applications.",
    achievements: [
  ...
  },
  {
    ...
    startDate: "Feb 2025",
    endDate: "Mar 2025",
    description: "Worked as a Python and Machine Learning Intern focusing on EDA, Data Analysis, and ML model development while contributing to multiple projects and team training initiatives.",
    achievements: [
