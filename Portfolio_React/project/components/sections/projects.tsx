  ...
  const filteredProjects = projects.filter((project) => {
    ...
    if (filter === "fullstack")
      return (
        ...
        project.tags.some((tag) => ["Node.js", "Express", "MongoDB", "Java", "FastaAPI", "Python"].includes(tag))
      )
    return true
  })
      ...
      >
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            A selection of my latest work. Each project represents a unique challenge and solution.
          </p>
  ...
  return (
    <Card className="overflow-hidden transition-all hover:shadow-md">
      <div className="relative aspect-video overflow-hidden">
        ...
        />
        {project.featured && <Badge className="absolute right-2 top-2">Featured</Badge>}
      </div>
      <CardContent className="p-6">
        <h3 className="font-semibold text-xl">{project.title}</h3>
        <p className="mt-2 line-clamp-2 text-muted-foreground text-sm">{project.description}</p>
